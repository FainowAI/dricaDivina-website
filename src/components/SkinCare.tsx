...
const SkinCare = () => {
  return <section className="py-14 md:py-17 lg:py-20 bg-secondary/30">
      <div className="container mx-auto px-4">
        ...
        loop: true
          ...
          <CarouselContent className="-ml-2 md:-ml-4">
            {products.map((product, index) => <CarouselItem key={index} className="pl-2 md:pl-4 basis-full sm:basis-1/2 lg:basis-1/3">
